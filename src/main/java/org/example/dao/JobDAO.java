...
public class JobDAO
{
    private static final String URL = "jdbc:sqlite:C:\\Users\\dev\\IdeaProjects\\HrApiDay11-EV\\src\\main\\java\\org\\example\\hr.db";
    ...
    public Response updateJob(Jobs job) throws SQLException, ClassNotFoundException {
        Class.forName("org.sqlite.JDBC");
        Connection conn = DriverManager.getConnection(URL);
